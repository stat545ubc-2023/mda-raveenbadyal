...
I chose this exercise because my proposed question above mentioned wanting to understand which types of trees grow in which neighborhoods, and if there is a difference in the types of trees that grow in each neighborhood. This subset of data allows you to focus on 6 columns instead of 21, and it contains the relevant information to determine which species grow in which neighborhoods.
```{r}
...
I chose this exercise because I wanted to understand the spread of diameter in the vancouver_trees dataset. This density plot shows that most trees have a diameter less than 100. There are trees with a diameter greater than 100 but there is less density of these trees. This will be useful for further analysis because I can filter the data based on diameter and compare other variables to a more focused diameter range.
```{r}
